"""
Monte Carlo Simulation of Spotify Stock Prices
"""
...
def plot_stock_simulation(stock_data, simulated_prices, title):
	"""
...
stock_symbol = 'SPOT'
start_date = datetime.now() - timedelta(days=3*365) #3 years worth of data
...
#Plotting data
plot_stock_simulation(stock_data, simulated_prices, 'Historical and Simulated Stock Prices')
